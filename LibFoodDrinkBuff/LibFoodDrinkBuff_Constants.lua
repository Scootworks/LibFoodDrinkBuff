...
assert(not LIB_FOOD_DRINK_BUFF, GetString(SI_LIB_FOOD_DRINK_BUFF_LIBRARY_LOADED))
...
if LibChatMessage then
	lib.chat = LibChatMessage(LFDB_LIB_IDENTIFIER, "LibFDB")
end
...
lib.LANGUAGES_SUPPORTED = LANGUAGES_SUPPORTED
...
lib.BLACKLIST_STRING_PATTERN = BLACKLIST_STRING_PATTERN
...
LFDB_BUFF_TYPE_REGEN_ALL = REGEN_HEALTH + LFDB_BUFF_TYPE_REGEN_MAGICKA + LFDB_BUFF_TYPE_REGEN_STAMINA
...
--Add global variable LIB_FOOD_DRINK_BUFF
